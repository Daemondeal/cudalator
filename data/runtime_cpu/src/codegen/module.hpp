// NOTE: This file is just for debugging purposes, it will be overwritten each
// time a new project is built.
#pragma once
...
void state_vcd_dump_values(state_work__double_int_adder* state, int tid,
                           fmt::ostream& file);
